...
public class VersionedIdFieldMappingFactory implements FieldMappingFactory {
  ...
  private static class Impl extends AbstractFieldMapping {
    ...
    public void translateFromCSVToObject(CsvEntityContext context,
      ...
      String idString = (String) csvValues.get(_csvFieldName);
      long id = Long.parseLong(idString);

      VersionedId versionedId = new VersionedId(version, id);
      object.setPropertyValue(_objFieldName, versionedId);
    }
    ...
    protected boolean isMissing(Map<String, Object> csvValues) {
      return super.isMissing(csvValues)
          || isMissing(csvValues, VersionedId.BASIS_VERSION_FIELD);
    }
  }
}
